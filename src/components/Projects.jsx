...
import { FiGithub, FiClock, FiCode } from 'react-icons/fi'

const placeholderProjects = [
  { id: 1, title: 'Coming Soon', subtitle: 'AI/ML Project', color: 'indigo' },
  { id: 2, title: 'Coming Soon', subtitle: 'Deep Learning Project', color: 'purple' },
  { id: 3, title: 'Coming Soon', subtitle: 'NLP Project', color: 'cyan' },
  { id: 4, title: 'Coming Soon', subtitle: 'Data Science Project', color: 'emerald' },
  { id: 5, title: 'Coming Soon', subtitle: 'Computer Vision', color: 'rose' },
  { id: 6, title: 'Coming Soon', subtitle: 'ML Research', color: 'amber' },
]
            ...
            return (
              ...
              >
                ...
                <div className="p-6 flex flex-col items-center justify-center min-h-[140px]">
                  {/* Icon */}
                  <div className={`w-12 h-12 rounded-xl glass flex items-center justify-center ${c.icon} mb-4`}>
                    <FiCode size={22} />
                  </div>
